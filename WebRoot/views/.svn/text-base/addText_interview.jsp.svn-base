  ...
  <div class="container">
    ...
    <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
      <ul class="nav navbar-nav">
            <li><a href="addInterview.html">面试管理</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-12 bootstrap-admin-col-left">
            <ul class="nav nav-pills pull-left">
                <li class="active" name="addText" onclick="changeView(this)"><a href="#addText" >添加题目</a></li>
                <li name="myText" onclick="changeView(this)"><a href="#myText" >查看我的题目</a></li>
                <li name="allText" onclick="changeView(this)"><a href="#allText" >查看所有题目</a></li>
            </ul>
        </div>
        <br>
        <br>
		<br>
        <div class="col-md-12" id="addText">
		            ...
		            <form class="form-horizontal">
		                <fieldset>
		                    ...
		                    <div class="form-group">
		                        <label class="col-lg-2 control-label" for="focusedInput" >题目</label>
		                        <div class="col-lg-10">
		                    ...
		                    <div class="form-group">
		                        <label class="col-lg-2 control-label" for="focusedInput">答案</label>
		                        <div class="col-lg-10">
        ...
        <div class="col-md-12" id="myText" style="display:none;">
            <div class="panel panel-default bootstrap-admin-no-table-panel">
	            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
	                <fieldset>
	                    <legend>我的题目:</legend>
            ...
            <div class="panel panel-default bootstrap-admin-no-table-panel">
	            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
	                <fieldset>
	                    ...
	                    <button type="button" class="btn btn-default" id="saveall">保存全部</button>
	                    <table class="table bootstrap-admin-table-with-actions">
				<!--所有问题 -->
	                        <thead>
	                        <tr>
	                        ...
	                        <!--  <tr>
	                            ...
	                            <td>                                
	                               <button  class="btn btn-primary"><span class="glyphicon glyphicon-eye-open">查看详情</span></button>
	                            </td>
	                        </tr>
	                        <tr>
	                            <td><input type="checkbox" class="checkbox"></td>   
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="password" class="control-label col-md-2">题目内容</label>
                            <div class="col-md-10">
                                <textarea type="text" id="" class="form-control" style="height: 200px"></textarea>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="password" class="control-label col-md-2">答案</label>
                            <div class="col-md-10">
...
<script type="text/javascript">
   ...
   //添加和查看按钮的切换
    function changeView(which){
        ...
        if(myname=="addText"){            
            document.getElementsByName("myText")[0].setAttribute("class","");
            ...
            document.getElementsByName("myText")[0].setAttribute("class","");
            document.getElementsByName("addText")[0].setAttribute("class","");
            myText.setAttribute("style","display:none;");
